...
urlpatterns = [
    ...
    path('proyecto/<int:proyecto_id>/cambiar-estado/<str:nuevo_estado>/', 
         views.cambiar_estado_proyecto_tutor, name='cambiar_estado'),
    path('proyecto/<int:proyecto_id>/asignar-tutor/', 
         views.asignar_tutor, name='asignar_tutor'),
    path('panel/admin/registrar-tutor/', 
         views.registrar_tutor, name='registrar_tutor'),
    
    # Nuevas URLs para administrador
    path('panel/admin/tutor/<int:tutor_id>/eliminar/', 
         views.eliminar_tutor, name='eliminar_tutor'),
    path('panel/admin/tutor/<int:tutor_id>/editar/', 
         views.editar_tutor, name='editar_tutor'),
    path('panel/admin/emprendedor/<int:emprendedor_id>/asignar-tutor/', 
    ...
    path('cambiar-estado-proyecto/<int:proyecto_id>/', views.cambiar_estado_proyecto_tutor, name='cambiar_estado_proyecto_tutor'),
    ...
    path('panel/admin/tutores/', views.lista_tutores, name='lista_tutores'),
